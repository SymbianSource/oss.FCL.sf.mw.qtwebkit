...
contains(DEFINES, ENABLE_HAPTICS=1) {
    SOURCES += platform/qt/PlatformHapticsQt.cpp
}
...
contains(DEFINES, ENABLE_TRANSFORMACTION_EVENTS=1) {
    HEADERS += page/TouchGestureHandler.h
    SOURCES += page/TouchGestureHandler.cpp
}
...
!CONFIG(QTDIR_build) {
    ...
    !symbian {
        ...
        # :HACK: Add export statements to the bld.inf
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QGraphicsWebView $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QGraphicsWebView)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebDatabase $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebDatabase)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebElement $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebElement)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebElementCollection $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebElementCollection)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebFrame $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebFrame)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebHistory $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebHistory)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebHistoryInterface $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebHistoryInterface)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebHistoryItem $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebHistoryItem)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebHitTestResult $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebHitTestResult)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebInspector $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebInspector)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebPage $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebPage)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebPluginFactory $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebPluginFactory)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebSecurityOrigin $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebSecurityOrigin)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebSettings $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebSettings)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QWebView $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QWebView)"
        BLD_INF_RULES.prj_exports += "../include/QtWebKit/QtWebKit $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/QtWebKit)"

        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qgraphicswebview.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qgraphicswebview.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebdatabase.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebdatabase.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebelement.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebelement.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebframe.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebframe.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebhistory.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebhistory.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebhistoryinterface.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebhistoryinterface.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebinspector.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebinspector.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebkitglobal.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebkitglobal.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebkitplatformplugin.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebkitplatformplugin.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebkitversion.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebkitversion.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebpage.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebpage.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebpluginfactory.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebpluginfactory.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebscriptworld.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebscriptworld.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebsecurityorigin.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebsecurityorigin.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebsettings.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebsettings.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebview.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/qwebview.h)"

        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebinspector_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebinspector_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebplugindatabase_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebplugindatabase_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebpage_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebpage_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebsecurityorigin_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebsecurityorigin_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebscriptworld_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebscriptworld_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebdatabase_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebdatabase_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebhistory_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebhistory_p.h)"
        BLD_INF_RULES.prj_exports += "../WebKit/qt/Api/qwebframe_p.h $$MW_LAYER_PUBLIC_EXPORT_PATH(QtWebKit/private/qwebframe_p.h)"
    }
