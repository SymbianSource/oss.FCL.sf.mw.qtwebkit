...
#if ENABLE(HAPTICS)
    EHapticTapType hapticTapType() const { return inherited->hapticTapType; }
    EHapticTapStrength hapticTapStrength() const { return inherited->hapticTapStrength; }
#endif
...
#if ENABLE(HAPTICS)  
    void setHapticTapType(EHapticTapType b) { SET_VAR(inherited, hapticTapType, b); }
    void setHapticTapStrength(EHapticTapStrength b) { SET_VAR(inherited, hapticTapStrength, b); }
#endif  
...
#if ENABLE(HAPTICS)
    static EHapticTapType initialHapticTapType() { return HBUTTON; }
    static EHapticTapStrength initialHapticTapStrength() { return HNONE; }
#endif
