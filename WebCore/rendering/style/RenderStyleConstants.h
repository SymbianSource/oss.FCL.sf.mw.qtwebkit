...
#if ENABLE(HAPTICS)
enum EHapticTapType {
    HBUTTON, HLATCHEDBUTTONDOWN, HLATCHEDBUTTONUP, HLATCHEDBUTTONSTUCK, HLINK, HCHECKEDCHECKBOX, HUNCHECKEDCHECKBOX
};

enum EHapticTapStrength {
    HNONE, HWEAK, HMEDIUM, HSTRONG
};
#endif
