...
// shorthand properties
    ...
    case CSSPropertyWebkitHapticTapStrength: {
        HANDLE_INHERIT_AND_INITIAL(hapticTapStrength, HapticTapStrength)
        m_style->setHapticTapStrength(*primitiveValue);
        return;
    }
    case CSSPropertyWebkitHapticTap: {
        if (isInherit) {
            m_style->setHapticTapType(m_parentStyle->hapticTapType());
            m_style->setHapticTapStrength(m_parentStyle->hapticTapStrength());
        } else if (isInitial) {
            m_style->setHapticTapType(RenderStyle::initialHapticTapType());
            m_style->setHapticTapStrength(RenderStyle::initialHapticTapStrength());
        }
        return;
    }
