...
{
    putDirect(exec->propertyNames().prototype, JSSVGFontFaceElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFontFaceElementPrototype(globalObject, JSSVGFontFaceElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
