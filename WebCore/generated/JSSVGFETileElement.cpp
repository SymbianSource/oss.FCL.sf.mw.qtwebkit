...
{
    putDirect(exec->propertyNames().prototype, JSSVGFETileElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFETileElementPrototype(globalObject, JSSVGFETileElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
