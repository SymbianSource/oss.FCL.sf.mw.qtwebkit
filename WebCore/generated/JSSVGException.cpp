...
{
    putDirect(exec->propertyNames().prototype, JSSVGExceptionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGExceptionPrototype(globalObject, JSSVGExceptionPrototype::createStructure(globalObject->objectPrototype()));
}
