...
{
    putDirect(exec->propertyNames().prototype, JSSVGPathSegPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGPathSegPrototype(globalObject, JSSVGPathSegPrototype::createStructure(globalObject->objectPrototype()));
}
