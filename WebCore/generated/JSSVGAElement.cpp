...
{
    putDirect(exec->propertyNames().prototype, JSSVGAElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAElementPrototype(globalObject, JSSVGAElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
