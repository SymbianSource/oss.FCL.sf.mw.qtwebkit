...
{
    putDirect(exec->propertyNames().prototype, JSSVGAnimatedBooleanPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAnimatedBooleanPrototype(globalObject, JSSVGAnimatedBooleanPrototype::createStructure(globalObject->objectPrototype()));
}
