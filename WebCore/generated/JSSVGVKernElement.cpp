...
const ClassInfo JSSVGVKernElementConstructor::s_info = { "SVGVKernElementConstructor", 0, &JSSVGVKernElementConstructorTable, 0 };

JSSVGVKernElementConstructor::JSSVGVKernElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGVKernElementConstructor::createStructure(globalObject->objectPrototype()), globalObject)
{
    putDirect(exec->propertyNames().prototype, JSSVGVKernElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
const ClassInfo JSSVGVKernElementPrototype::s_info = { "SVGVKernElementPrototype", 0, &JSSVGVKernElementPrototypeTable, 0 };
...
{
    return new (exec) JSSVGVKernElementPrototype(globalObject, JSSVGVKernElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
