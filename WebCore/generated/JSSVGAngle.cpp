...
{
    putDirect(exec->propertyNames().prototype, JSSVGAnglePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAnglePrototype(globalObject, JSSVGAnglePrototype::createStructure(globalObject->objectPrototype()));
}
...
void setJSSVGAngleValue(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    JSSVGPODTypeWrapper<SVGAngle> * imp = static_cast<JSSVGPODTypeWrapper<SVGAngle> *>(castedThis->impl());
    SVGAngle podImp(*imp);
