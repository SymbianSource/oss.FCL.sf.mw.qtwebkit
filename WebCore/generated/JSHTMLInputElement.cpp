...
static const HashTableValue JSHTMLInputElementTableValues[40] =
{
...
static JSC_CONST_HASHTABLE HashTable JSHTMLInputElementTable = { 133, 127, JSHTMLInputElementTableValues, 0 };
...
{
    putDirect(exec->propertyNames().prototype, JSHTMLInputElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLInputElementPrototype(globalObject, JSHTMLInputElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
