...
{
    putDirect(exec->propertyNames().prototype, JSSVGFEDistantLightElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFEDistantLightElementPrototype(globalObject, JSSVGFEDistantLightElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
