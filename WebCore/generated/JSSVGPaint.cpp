...
{
    putDirect(exec->propertyNames().prototype, JSSVGPaintPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGPaintPrototype(globalObject, JSSVGPaintPrototype::createStructure(JSSVGColorPrototype::self(exec, globalObject)));
}
...
EncodedJSValue JSC_HOST_CALL jsSVGPaintPrototypeFunctionSetPaint(ExecState* exec)
{
    ...
    SVGPaint* imp = static_cast<SVGPaint*>(castedThis->impl());
    ExceptionCode ec = 0;
    SVGPaint::SVGPaintType paintType = static_cast<SVGPaint::SVGPaintType>(exec->argument(0).toInt32(exec));
