...
{
    putDirect(exec->propertyNames().prototype, JSSVGAnimatedPreserveAspectRatioPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAnimatedPreserveAspectRatioPrototype(globalObject, JSSVGAnimatedPreserveAspectRatioPrototype::createStructure(globalObject->objectPrototype()));
}
