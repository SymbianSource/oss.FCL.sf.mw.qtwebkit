...
{
    putDirect(exec->propertyNames().prototype, JSSVGTitleElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGTitleElementPrototype(globalObject, JSSVGTitleElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
