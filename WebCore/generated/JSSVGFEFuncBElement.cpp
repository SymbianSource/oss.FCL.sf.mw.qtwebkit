...
{
    putDirect(exec->propertyNames().prototype, JSSVGFEFuncBElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFEFuncBElementPrototype(globalObject, JSSVGFEFuncBElementPrototype::createStructure(JSSVGComponentTransferFunctionElementPrototype::self(exec, globalObject)));
}
