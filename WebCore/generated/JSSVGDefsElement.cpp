...
{
    putDirect(exec->propertyNames().prototype, JSSVGDefsElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGDefsElementPrototype(globalObject, JSSVGDefsElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
