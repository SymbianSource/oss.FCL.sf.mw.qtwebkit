...
{
    putDirect(exec->propertyNames().prototype, JSSVGFontElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFontElementPrototype(globalObject, JSSVGFontElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
