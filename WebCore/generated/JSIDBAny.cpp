...
public:
    JSIDBAnyConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
const ClassInfo JSIDBAnyConstructor::s_info = { "IDBAnyConstructor", 0, &JSIDBAnyConstructorTable, 0 };

JSIDBAnyConstructor::JSIDBAnyConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSIDBAnyConstructor::createStructure(globalObject->objectPrototype()), globalObject)
{
    putDirect(exec->propertyNames().prototype, JSIDBAnyPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}

bool JSIDBAnyConstructor::getOwnPropertySlot(ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSIDBAnyConstructor, DOMObject>(exec, &JSIDBAnyConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSIDBAnyConstructor, DOMObject>(exec, &JSIDBAnyConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSIDBAnyPrototype::s_info = { "IDBAnyPrototype", 0, &JSIDBAnyPrototypeTable, 0 };
...
const ClassInfo JSIDBAny::s_info = { "IDBAny", 0, &JSIDBAnyTable, 0 };

JSIDBAny::JSIDBAny(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<IDBAny> impl)
...
{
    return new (exec) JSIDBAnyPrototype(globalObject, JSIDBAnyPrototype::createStructure(globalObject->objectPrototype()));
}
