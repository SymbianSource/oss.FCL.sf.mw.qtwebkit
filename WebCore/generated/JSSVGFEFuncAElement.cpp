...
{
    putDirect(exec->propertyNames().prototype, JSSVGFEFuncAElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFEFuncAElementPrototype(globalObject, JSSVGFEFuncAElementPrototype::createStructure(JSSVGComponentTransferFunctionElementPrototype::self(exec, globalObject)));
}
