...
static const HashTableValue JSXMLHttpRequestTableValues[15] =
{
...
const ClassInfo JSXMLHttpRequestConstructor::s_info = { "XMLHttpRequestConstructor", 0, &JSXMLHttpRequestConstructorTable, 0 };
...
{
    putDirect(exec->propertyNames().prototype, JSXMLHttpRequestPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSXMLHttpRequestPrototype(globalObject, JSXMLHttpRequestPrototype::createStructure(globalObject->objectPrototype()));
}
