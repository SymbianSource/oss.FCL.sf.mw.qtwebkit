...
{
    putDirect(exec->propertyNames().prototype, JSSVGAnimatedIntegerPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAnimatedIntegerPrototype(globalObject, JSSVGAnimatedIntegerPrototype::createStructure(globalObject->objectPrototype()));
}
