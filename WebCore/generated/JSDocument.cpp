...
static const HashTableValue JSDocumentTableValues[78] =
{
    ...
    { "ontransformactionstart", DontDelete | DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentOntransformactionstart), (intptr_t)setJSDocumentOntransformactionstart THUNK_GENERATOR(0) },
#endif
#if ENABLE(TRANSFORMACTION_EVENTS)
    { "ontransformactionupdate", DontDelete | DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentOntransformactionupdate), (intptr_t)setJSDocumentOntransformactionupdate THUNK_GENERATOR(0) },
#endif
#if ENABLE(TRANSFORMACTION_EVENTS)
    { "ontransformactionend", DontDelete | DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentOntransformactionend), (intptr_t)setJSDocumentOntransformactionend THUNK_GENERATOR(0) },
#endif
...
#if ENABLE(TRANSFORMACTION_EVENTS)
JSValue jsDocumentOntransformactionstart(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
#if ENABLE(TRANSFORMACTION_EVENTS)
JSValue jsDocumentOntransformactionupdate(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
#if ENABLE(TRANSFORMACTION_EVENTS)
JSValue jsDocumentOntransformactionend(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
#if ENABLE(TRANSFORMACTION_EVENTS)
void setJSDocumentOntransformactionstart(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(static_cast<JSDocument*>(thisObject)->impl());
...
#if ENABLE(TRANSFORMACTION_EVENTS)
void setJSDocumentOntransformactionupdate(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(static_cast<JSDocument*>(thisObject)->impl());
...
#if ENABLE(TRANSFORMACTION_EVENTS)
void setJSDocumentOntransformactionend(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(static_cast<JSDocument*>(thisObject)->impl());
