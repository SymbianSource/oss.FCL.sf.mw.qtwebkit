...
JSC::JSValue jsElementOntransformactionstart(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOntransformactionstart(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsElementOntransformactionupdate(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOntransformactionupdate(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsElementOntransformactionend(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOntransformactionend(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
