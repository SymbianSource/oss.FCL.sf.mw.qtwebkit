...
{
    putDirect(exec->propertyNames().prototype, JSSVGFontFaceSrcElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFontFaceSrcElementPrototype(globalObject, JSSVGFontFaceSrcElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
