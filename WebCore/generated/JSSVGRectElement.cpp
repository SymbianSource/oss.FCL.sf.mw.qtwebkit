...
{
    putDirect(exec->propertyNames().prototype, JSSVGRectElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGRectElementPrototype(globalObject, JSSVGRectElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
