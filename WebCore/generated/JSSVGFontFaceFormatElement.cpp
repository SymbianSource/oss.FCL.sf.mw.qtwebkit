...
{
    putDirect(exec->propertyNames().prototype, JSSVGFontFaceFormatElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGFontFaceFormatElementPrototype(globalObject, JSSVGFontFaceFormatElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
