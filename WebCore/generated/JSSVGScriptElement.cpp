...
{
    putDirect(exec->propertyNames().prototype, JSSVGScriptElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGScriptElementPrototype(globalObject, JSSVGScriptElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
