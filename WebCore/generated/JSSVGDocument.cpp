...
{
    putDirect(exec->propertyNames().prototype, JSSVGDocumentPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGDocumentPrototype(globalObject, JSSVGDocumentPrototype::createStructure(JSDocumentPrototype::self(exec, globalObject)));
}
