...
{
    putDirect(exec->propertyNames().prototype, JSSVGAnimatedNumberListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAnimatedNumberListPrototype(globalObject, JSSVGAnimatedNumberListPrototype::createStructure(globalObject->objectPrototype()));
}
