...
{
    putDirect(exec->propertyNames().prototype, JSSVGPathSegLinetoHorizontalRelPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGPathSegLinetoHorizontalRelPrototype(globalObject, JSSVGPathSegLinetoHorizontalRelPrototype::createStructure(JSSVGPathSegPrototype::self(exec, globalObject)));
}
