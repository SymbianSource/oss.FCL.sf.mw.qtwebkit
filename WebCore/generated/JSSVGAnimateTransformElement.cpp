...
{
    putDirect(exec->propertyNames().prototype, JSSVGAnimateTransformElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGAnimateTransformElementPrototype(globalObject, JSSVGAnimateTransformElementPrototype::createStructure(JSSVGAnimationElementPrototype::self(exec, globalObject)));
}
