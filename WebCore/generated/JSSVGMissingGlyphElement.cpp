...
{
    putDirect(exec->propertyNames().prototype, JSSVGMissingGlyphElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSSVGMissingGlyphElementPrototype(globalObject, JSSVGMissingGlyphElementPrototype::createStructure(JSSVGElementPrototype::self(exec, globalObject)));
}
